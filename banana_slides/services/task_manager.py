            ...
            def generate_single_desc(page_id, page_outline, page_index):
                ...
                with app.app_context():
                    try:
                        ...
                        from banana_slides.services.ai_service_manager import (
                            get_ai_service,
                        )
...
def export_editable_pptx_with_recursive_analysis_task(
    ...
    with app.app_context():
        ...
        from banana_slides.models import Project
        ...
        try:
            ...
            # Step 2: 创建文字属性提取器
            from banana_slides.services.image_editability import (
            ...
            logger.info(
                f"Step 3: 创建可编辑PPTX (extractor={export_extractor_method}, inpaint={export_inpaint_method})..."
            )
            progress_callback(
                "配置",
                ...
                task.set_progress(
                    {
                        ...
                        "warning_details": export_warnings.to_dict()
                        if export_warnings
                        else {},  # 详细警告信息
                    }
                )
