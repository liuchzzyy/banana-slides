...
# from ..core.generator import AIService  <-- Removed
...
_ai_service_instance: Optional["AIService"] = None  # Use string forward reference
_lock = Lock()
    ...
    if _ai_service_instance is None:
        with _lock:
            ...
            if _ai_service_instance is None:
                ...
                from ..core.generator import AIService
                ...
                if has_app_context() and current_app and hasattr(current_app, "config"):
                    ...
                    image_model = current_app.config.get(
                ...
                _ai_service_instance = AIService(
                    text_provider=text_provider, image_provider=image_provider
                )

                logger.info(
                    f"AIService singleton created with models: text={text_model}, image={image_model}"
                )
